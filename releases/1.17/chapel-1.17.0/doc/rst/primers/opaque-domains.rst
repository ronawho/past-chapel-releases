...
.. _primers-opaque-domains:

Opaque Domains and Arrays
=========================

`View opaque-domains.chpl on GitHub <https://github.com/chapel-lang/chapel/blob/master/test/release/examples/primers/opaque-domains.chpl>`_

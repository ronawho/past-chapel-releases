...
.. _primers-voidVariables:

Void variables and fields
=========================

`View voidVariables.chpl on GitHub <https://github.com/chapel-lang/chapel/blob/master/test/release/examples/primers/voidVariables.chpl>`_

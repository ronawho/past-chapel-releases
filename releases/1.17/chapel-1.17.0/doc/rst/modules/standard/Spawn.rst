...
.. method:: proc subprocess.wait(out error: syserr, buffer = true)
...
.. method:: proc subprocess.close(out error: syserr)
...
.. method:: proc subprocess.send_signal(out error: syserr, signal: int)
...
.. method:: proc subprocess.kill(out error: syserr)
...
.. method:: proc subprocess.terminate(out error: syserr)

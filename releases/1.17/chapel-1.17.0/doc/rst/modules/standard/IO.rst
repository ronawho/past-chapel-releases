...
.. record:: iostyle
   ...
   .. attribute:: var str_style: int(64) = iostringstyle.data_toeof
...
.. method:: proc file.check(out error: syserr)
...
.. function:: proc open(path: string = "", mode: iomode, hints: iohints = IOHINT_NONE, style: iostyle = defaultIOStyle(), url: string = ""): file throws
...
.. method:: proc channel.mark(): syserr
...
.. function:: proc openreader(out error: syserr, path: string = "", param kind = iokind.dynamic, param locking = true, start: int(64) = 0, end: int(64) = max(int(64)), hints: iohints = IOHINT_NONE, url: string = ""): channel(false, kind, locking)
...
.. function:: proc openwriter(out error: syserr, path: string = "", param kind = iokind.dynamic, param locking = true, start: int(64) = 0, end: int(64) = max(int(64)), hints: iohints = IOHINT_NONE, url: string = ""): channel(true, kind, locking)
...
.. function:: proc <~>(const ref ch: channel, x) const ref
...
.. function:: proc <~>(const ref r: channel, lit: ioLiteral) const ref
...
.. function:: proc <~>(const ref r: channel, nl: ioNewline) const ref
...
.. method:: proc channel.writeBytes(x, len: ssize_t, out error: syserr): bool
...
.. method:: proc channel.readline(arg: [] uint(8), out numRead: int, start = arg.domain.low, amount = arg.domain.high-start+1, out error: syserr): bool
...
.. method:: proc channel.write(const args ...?k, style: iostyle, out error: syserr): bool
...
.. method:: proc channel.writeln(const args ...?k, style: iostyle, out error: syserr): bool
...
.. method:: proc channel.assertEOF(error: string = "- Not at EOF") throws
...
.. function:: proc stdinInit()

.. function:: proc stdoutInit()

.. function:: proc stderrInit()

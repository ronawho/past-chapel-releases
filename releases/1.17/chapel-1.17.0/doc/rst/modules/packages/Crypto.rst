...
.. class:: Envelope
   ...
   .. method:: proc init(iv: CryptoBuffer, encSymmKey: [] CryptoBuffer, encSymmValue: CryptoBuffer)
...
.. class:: Hash
   ...
   .. method:: proc init(digestName: string)
   ...
   .. method:: proc getDigest(inputBuffer: CryptoBuffer): CryptoBuffer
...
.. class:: AES
   ...
   .. method:: proc init(bits: int, mode: string)
   ...
   .. method:: proc encrypt(plaintext: CryptoBuffer, key: CryptoBuffer, IV: CryptoBuffer): CryptoBuffer
   ...
   .. method:: proc decrypt(ciphertext: CryptoBuffer, key: CryptoBuffer, IV: CryptoBuffer): CryptoBuffer
...
.. class:: Blowfish
   ...
   .. method:: proc encrypt(plaintext: CryptoBuffer, key: CryptoBuffer, IV: CryptoBuffer): CryptoBuffer throws
...
.. class:: CryptoRandom
   ...
   .. method:: proc createRandomBuffer(buffLen: int): CryptoBuffer throws
...
.. class:: KDF
   ...
   .. method:: proc passKDF(userKey: string, saltBuff: CryptoBuffer): CryptoBuffer
...
.. class:: RSA
   ...
   .. method:: proc encrypt(plaintext: CryptoBuffer, keys: [] RSAKey): Envelope
   ...
   .. method:: proc decrypt(envp: Envelope, key: RSAKey): CryptoBuffer throws

...
.. function:: proc search(Data: [?Dom], val, comparator: ?rec = defaultComparator, lo = Dom.low, hi = Dom.high, sorted = false)
...
.. function:: proc linearSearch(Data: [?Dom], val, comparator: ?rec = defaultComparator, lo = Dom.low, hi = Dom.high)
...
.. function:: proc binarySearch(Data: [?Dom], val, comparator: ?rec = defaultComparator, in lo = Dom.low, in hi = Dom.high)
